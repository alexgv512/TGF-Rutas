    ...
    <?php if (isset($_SESSION['identity'])): ?>
        <div class="profile-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-9">
                    <h2 class="text-dark mb-3"><?= htmlspecialchars($_SESSION['identity']['nombre'] . ' ' . $_SESSION['identity']['apellidos']) ?></h2>
        ...
        <div class="modern-card mb-4">
            <div class="card-header-modern">
                <ul class="nav nav-tabs border-0 mb-0" id="profileTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active text-dark" id="rutas-tab" data-toggle="tab" href="#rutas" role="tab">
                            <i class="fas fa-route mr-2"></i>Mis Rutas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" id="valoraciones-tab" data-toggle="tab" href="#valoraciones" role="tab">
                ...
                <div class="tab-content" id="profileTabsContent">
                    <div class="tab-pane fade show active" id="rutas" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h3 class="text-dark">Mis Rutas</h3>
                    ...
                    <div class="tab-pane fade" id="valoraciones" role="tabpanel">
                        <h3 class="text-dark mb-4">Mis Valoraciones</h3>
