...
<div class="container mt-5">
    <div class="jumbotron">
        ...
        <?php if (!isset($_SESSION['identity'])): ?>
            <a href="<?= BASE_URL ?>usuario/registrarse" class="btn btn-primary mr-2">Regístrate</a>
            <a href="<?= BASE_URL ?>usuario/login" class="btn btn-outline-secondary">Iniciar Sesión</a>
        <?php else: ?>
            <a href="<?= BASE_URL ?>ruta/crear" class="btn btn-primary mr-2">Crear Ruta</a>
            <a href="<?= BASE_URL ?>ruta/explorar" class="btn btn-outline-secondary">Explorar Rutas</a>
        <?php endif; ?>
    </div>
    ...
    <div class="text-center mt-4 mb-5">
        <a href="<?= BASE_URL ?>ruta/explorar" class="btn btn-lg btn-outline-primary">Ver Todas las Rutas</a>
    </div>
